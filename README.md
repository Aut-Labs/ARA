...
_____________
🏗 Scaffold-ETH 2 ⚙️ Built using NextJS, RainbowKit, Hardhat, Wagmi, and Typescript.
...
- [Aut Retroactive Attestation Specification](#aut-retroactive-attestation-specification)
  - [Should](#should)
  - [Use (internal)](#use-internal)
- [Aut Retroactive Attestation](#aut-retroactive-attestation)
- [Contents](#contents)
